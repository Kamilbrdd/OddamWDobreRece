...
<section id="steps" class="form--steps">
...
<%--                <form:checkboxes path="categories" itemLabel="name" delimiter="<br>" id="categories"--%>
<%--                                 items="${categories}" />--%>
                    <c:forEach items="${categories}" var="category">
                        ...
                        <label>
                            <input
                                    ...
                                    value=${category.id}
                            />
<%--                            <form:checkbox path="categories" value="${category.id}" id="category" />--%>
            ...
            <div data-step="2">
                ...
                <div class="form-group form-group--inline">
                    <label>
                        Liczba 60l worków:
                        <form:input path="quantity" type="number" id="quantity"/><br>
                    </label>
                </div>
...
<%--                <div class="form-group form-group--checkbox">--%>
<%--                    <form:select path="institution" items="${institutions}" itemValue="id" itemLabel="name" id="institution"/>--%>
<%--                </div>--%>

                <c:forEach items="${institutions}" var="institution">
                    <div class="form-group form-group--checkbox"> <!-- Zmiana klasy na form-group--radio -->
                        <label>
                            <input type="radio" name="institution" id="institution" value="${institution.id}" /> <!-- Dodanie nawiasów klamrowych -->
